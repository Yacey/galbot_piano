...
SCORE = [
    ...
    (5, 0.5), (5, 0.5), (5, 0.25), (5, 1,True), 

    # 也不是没伤痕
    (0, 0.5,True), (1, 0.5,True),
    (5, 0.5), (5, 0.5), (5, 0.25), (5, 0.5),(5,0.5,True), (3, 1,True),

    # 是明白爱是信仰的延伸
    (0, 1), (8, 0.5), (8, 0.5,True), (7, 0.5),(6, 0.5,True), (5, 0.5), (4, 0.5,True), 
    (3, 0.5), (4, 0.5,True), (3, 0.5), (5, 0.5,True), (5, 1), (0, 1),


    # 什么特征
    (0, 0.5,True),(0, 1,True), (3, 0.5), (8, 0.5), (8, 0.5), (8, 0.5),(8, 1,True),

    # 人缘还是眼神 也不会
    (0, 0.5,True),(0, 1,True), (6, 0.5), (7, 0.5,True), (8, 0.5), (9, 0.5,True),(6, 0.5), (7, 0.5,True), 
    (0, 0.5),(5, 0.5),(6,0.5,True),(6,0.5), (7,0.5,True),


    # 预知爱 不爱的可能
    (7, 0.5), (8, 0.5), (8, 0.5,True), (8, 0.5), (7, 0.5,True),(5, 0.5,True),(1, 0.5), (3, 0.5,True), 
    (2,4,True),(0,1,True),


    # 保持单身
    (0, 1,True),(0, 1,True),(1, 0.5), 
    (5, 0.5), (5, 0.5), (5, 0.25), (5, 1,True), (0, 1,True),
    

    # 忍不住又沉沦
    (0, 1,True),(0, 1,True), (1, 0.5), (5, 0.5), (5, 0.5), (5, 0.25,True), (5, 0.5), (4,0.5),(3,0.5,True),(3,1,True),
    (0, 1,True),

    # 兜着圈子来去又是苦等
    (0, 1,True), (0, 1,True),(8, 0.5), (8, 0.5,True), (7, 0.5), (6, 0.5,True), (5, 0.5), (4,0.5,True),
    (3,0.5,True),(3,1,True),(0, 1,True),

    # 又是苦等
    (0, 1,True), (3, 0.5), (4, 0.5,True), (3, 0.5), (3, 0.5,True),(2,1,True),
    (0, 1,True),

    # 人的一生 感情是旋转门 转到了
    (0, 1,True),(0, 1,True), (8, 0.5), (7, 0.5), (8, 0.5,True), (8, 1,True), 
    (0, 1,True), (0, 0.5,True), (6,0.5),(7,0.5,True),
    (8,0.5),(9,0.5,True),(6,0.5),(7,0.5,True),(7,0.5),(5, 0.5), (6, 0.5,True), (6, 0.5), (7, 0.5,True),


    # 最后真心的就不分
    (7,0.5),(8,0.5),(8,0.5),(8,0.5),(7,0.5,True),(6, 0.5), (5, 0.5,True), (1, 0.5), (5, 0.5,True),(5,4,True),
    (0, 1,True),(0, 1,True),

    # 有过竞争
    (0, 1,True),(0, 1,True), (1, 0.5), (5, 0.5), (5, 0.5), (5, 0.25), (5, 0.5,True),(0, 1,True),
    

    # 有过牺牲 被爱筛选过程 学会认真 学会忠诚
    (1,0.5,True), (5, 0.5), (5, 0.5), (5, 0.25), (5, 0.5,True),
    (0, 1,True),
    (1,0.5,True),(5, 0.5), (6, 0.5,True), (7, 0.5), (8, 0.5,True),
    (6,0.5),(5, 0.5,True), (5, 0.5,True), (1, 0.5,True), 
    (5, 0.5), (5, 0.5), (5, 0.25), (5, 0.5,True),(1,0.5,True),
    (5, 0.5),(5,0.5,True),(6,0.5,True),(6,0.5,True),(1, 0.5,True),
