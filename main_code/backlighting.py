...
SCORE = [
    # 低八度 5（note=10，G3）
    # 低八度 6（note=11，A3）
    # 低八度 7 = note = 12 = 低八度 B3

    # 也许我一直害怕有答案
    (0, 0.5 ,True),(10, 0.5,True), 
    (10, 0.5), (1, 0.5,True), 
    (2, 0.5), (1, 0.5,True), (2, 0.5), (1, 0.5,True),
    (2, 0.5), (3, 0.5,True), (5, 1,True), (0, 1 ,True),
    ...
    # 离开释怀很短暂又重来
    (0, 0.5 ,True), (10, 0.5,True),
    (6, 1,True), (3, 0.5), (2, 1,True), (3, 0.5), (4, 0.5,True), 
    (5, 1),(4, 0.5), (5, 0.5,True), (3, 1,True), 

    # 有时候自问自答
    (0, 0.5 ,True),(11, 0.5,True), (12, 0.5), (1, 0.5, True), (3, 0.5), (5, 0.5), (6, 0.5,True), 
    (3, 0.25),(2, 0.5), (2, 2,True), 
    ...
    # 我不要困难把我们击散
    (0, 0.5 ,True), (10, 0.5,True), 
    (10, 0.5), (1, 0.5, True), (2, 0.5), (1, 0.5, True), (2, 0.5), (3, 0.5,True),(5, 1 ,True), 
    ...
    # 我责备自己那么不勇敢
    (0, 0.5 ,True), (10, 0.5,True), 
    (10, 0.5), (1, 0.5, True), (2, 0.5), (1, 0.5, True), (2, 0.5), (1, 0.5, True) , (2, 0.5), (3, 0.5,True),(5, 1 ,True), 

    # 休止符
    (0, 1 ,True), 

    # 遗憾没有到达
    (0, 0.5 ,True), (5, 0.5,True), 
    (8, 0.5), (6, 0.5, True), (6, 0.5), (5, 0.5, True), (6, 1, True), 
    

    # 拥抱过还是害怕
    (8, 0.5) , (9, 0.5,True), 
    (7, 0.5), (5, 0.5,True), (5, 0.5), (3, 0.5, True), (6, 0.5), (5, 0.5, True), (5, 0.5, True), 

    # 用力推开你我一人留下
    (5, 0.5 ,True), 
    (6, 0.5), (3, 0.5,True), (2, 0.5), (1, 0.5, True), (6, 0.5), (3, 0.5, True),(2 , 0.5),(1 , 0.5,True),
    (5, 1,True),
    ...
    # 有一束光那瞬间
    (5, 0.5), (8, 0.5,True), (7, 0.5), (8, 0.5,True), (0, 0.5, True), (8, 0.5,True), (6, 0.5), (8 , 0.5,True),

    # 是什么痛的刺眼
    (0 , 0.5,True), (8, 0.5 ,True),  (7, 0.5), (8, 0.5,True), (9, 0.5), (8, 0.5,True),(7, 0.5), (5 , 0.5,True),

    # 你的视线是谅解
    (3, 0.5), (8, 0.5,True), (7, 0.5), (8, 0.5, True), (0, 0.5), (8, 0.5, True),(7 , 0.5),(8 , 0.5,True),
    ...
    # 我逆着 
    (0 , 0.5,True), (6, 0.5 ,True),  (7, 0.5), (8, 0.5,True),

    # 光
    (5, 1,True),

    # 却看见
    (0 , 0.5,True), (3, 0.5 ,True), (3 , 0.5,True), (5, 0.5 ,True),(5 , 0.5,True), (5, 2 ,True),  
    ...
    # 我身旁
    (0, 0.5,True), (8, 0.5,True), (7, 0.5), (8, 0.5,True), (8, 2,True),
    ...
    # 我以为
    (0 , 0.5,True), (8, 0.5 ,True),  (7, 0.5), (5, 0.5,True),

    # 无路后退
    (3 , 0.5,True), (0, 0.5 ,True),  (3, 0.5), (0, 0.5,True),(3 , 0.5,True), (0, 0.5 ,True),  (3, 0.5), (0, 0.5,True),

    # 反复证明
    (0 , 0.5,True), (3, 0.5 ,True),  (2, 0.5), (3, 0.5), (6 , 1), 

    # 这份爱
    (8, 0.5),  (7, 0.5), (5, 0.5,True),

    # 有多不对
    (3 , 0.5,True), (0, 0.5 ,True),  (3, 0.5), (0, 0.5,True),(3 , 0.5,True), (0, 0.5 ,True),  (3, 0.5), (0, 0.5,True),

    # 背对着你 如此漆黑
    (0, 0.5 ,True),  (3, 0.5,True), (3, 0.5),(2 , 0.5,True), (3, 0.5),(2 , 0.5,True), (2 , 0.5,True),(1, 0.5,True), 
    (6 ,1 ,True),

    # 忍住疲惫
    (0, 0.5 ,True),  (3, 0.5,True), (2 , 0.5,True), (1, 0.5,True), (5 , 1,True),

    # 睁开眼
    (0, 0.5 ,True),  (3, 0.5,True), (4, 0.5),(5, 0.5,True), 
    ...
    # 你就是光芒
    (6, 0.5),  (5, 0.5,True), (3, 0.5),(6, 0.5,True), (5, 0.5,True),
    (5, 1,True), 
    ...
    # 我身旁
    (0, 0.5,True), (8, 0.5,True), (7, 0.5), (8, 0.5,True), (8, 2,True),(8, 2,True)
